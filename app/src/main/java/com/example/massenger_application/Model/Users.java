...
public class Users {
    private String associatedId,name,image,status,last_seen_status;
    ...
    public Users(String associatedId, String name, String image, String status, String last_seen_status) {
